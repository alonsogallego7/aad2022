...
class UsersRemoteDataSource {
    ...
    fun getUsers(): List<User>{
        return mutableListOf(
            ...
            User(2, "User2", "Username2", "Email2", Address("Street2", "Suite2", "City2", "Zipcode2", "Geo2"), "Phone2", "Website2", Company("Name2", "CatchPhrase2", "Bs2")),
            User(3, "User3", "Username3", "Email3", Address("Street3", "Suite3", "City3", "Zipcode3", "Geo3"), "Phone3", "Website3", Company("Name3", "CatchPhrase3", "Bs3")),
